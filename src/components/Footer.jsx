  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 px-6">
      <div className="max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {/* Column 1 - Brand */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-4">Custom<span className="text-blue-700">Tech</span>Labs</h2>
          <p className="text-gray-400 text-sm leading-relaxed">
            Building innovative digital experiences that transform your ideas into reality.
          </p>
        </div>
      ...
      {/* Divider */}
      <div className="border-t border-gray-700 mt-10 pt-6 flex flex-row sm:flex-row justify-between items-center text-sm text-gray-500 max-w-7xl mx-auto">
        <p className="items-center justify-center">© {new Date().getFullYear()} CustomTech. All rights reserved.</p>

        {/* Social Icons */}
        <div className="flex gap-4 mt-4 sm:mt-0">
          <a href="#" className="hover:text-blue-400"><Facebook size={30} /></a>
          <a href="#" className="hover:text-blue-400"><Instagram size={30} /></a>
          <a href="#" className="hover:text-blue-400"><Linkedin size={30} /></a>
          <a href="#" className="hover:text-blue-400"><Twitter size={30} /></a>
        </div>
      </div>
    </footer>
  );
